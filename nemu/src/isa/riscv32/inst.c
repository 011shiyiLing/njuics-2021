...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */)           \
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 00100 11", slli, I, R(dest) = ((unsigned)src1 << src2));
  INSTPAT("0000000 ????? ????? 101 ????? 00100 11", srli, I, R(dest) = ((unsigned)src1 >> src2));
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 01100 11", sll, R, R(dest) = ((unsigned)src1 << (src2 & 0x1f)));//0
  INSTPAT("0000000 ????? ????? 111 ????? 01100 11", and, R, R(dest) = src1 & src2);
  INSTPAT("0000000 ????? ????? 110 ????? 01100 11", or, R, R(dest) = src1 | src2);
  INSTPAT("0000000 ????? ????? 100 ????? 01100 11", xor, R, R(dest) = src1 ^ src2);
  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", mul, R, R(dest) = src1 * src2);//1
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div, R, sword_t t = (sword_t)src1; sword_t p = (sword_t)src2; R(dest) = t / p);//0
  INSTPAT("0000000 ????? ????? 011 ????? 01100 11", sltu, R, R(dest) = (src1 < src2) ? 1:0);
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem, R, sword_t t = (sword_t)src1; sword_t p = (sword_t)src2; R(dest) = t % p);//1
  ...
  INSTPAT("0000000 ????? ????? 101 ????? 01100 11", srl, R, R(dest) = ((unsigned)src1 >> (src2 & 0x1f)));
