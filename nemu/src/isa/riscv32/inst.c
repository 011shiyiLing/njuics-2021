...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */)           \
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh, R, int64_t t = (int64_t)src1; int64_t p = (int64_t)src2; R(dest) = (sword_t)((t * p) >> 32));
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu, R, uint64_t t = (uint64_t)src1; uint64_t p = (uint64_t)src2; R(dest) = ((t*p) >> 32));
