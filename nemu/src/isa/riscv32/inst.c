...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */)           \
  ...
  INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall, N, bool success = true; word_t no = isa_reg_str2val("a7", &success);printf("%u\n",cpu.gpr[17]);if(!success) assert(0);vaddr_t addr = isa_raise_intr(no,s->pc);s->dnpc = addr);
