...
AM_DEVREG( 5, TIMER_RTC,    RD, int year, month, day, hour, minute, second);//AM_TIMER_RTC
AM_DEVREG( 6, TIMER_UPTIME, RD, uint64_t us);//AM_TIMER_UPTIME
AM_DEVREG( 7, INPUT_CONFIG, RD, bool present);
AM_DEVREG( 8, INPUT_KEYBRD, RD, bool keydown; int keycode);//AM_INPUT_KEYBRD
